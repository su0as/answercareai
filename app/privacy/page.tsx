      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10" style={BODY}>
          ...
          <section>
            ...
            <p className="text-[16px] text-[#707070] leading-[1.65] mb-4">
              We collect information in two contexts: from our business clients and from the callers your AI receptionist handles.
            </p>
            <p className="text-[15px] text-[#1d1d1f] mb-2" style={{ fontWeight: 500 }}>From Business Clients:</p>
            <ul className="list-disc pl-5 space-y-2 mb-5 text-[15px] text-[#707070] leading-[1.65]">
            ...
            <p className="text-[15px] text-[#1d1d1f] mb-2" style={{ fontWeight: 500 }}>From Caller Interactions (on behalf of our clients):</p>
            <ul className="list-disc pl-5 space-y-2 text-[15px] text-[#707070] leading-[1.65]">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-[15px] text-[#707070] leading-[1.65]">
              <li><strong className="text-[#1d1d1f] font-medium">Service providers:</strong> Payment processors, cloud infrastructure providers, and telephony carriers who support our operations under strict data processing agreements</li>
              <li><strong className="text-[#1d1d1f] font-medium">Your business systems:</strong> Scheduling software, CRMs, or other tools you direct us to integrate with</li>
              <li><strong className="text-[#1d1d1f] font-medium">Legal authorities:</strong> Where required by law, court order, or to protect the rights and safety of AnswerCare AI, our clients, or others</li>
              <li><strong className="text-[#1d1d1f] font-medium">Business transfers:</strong> In the event of a merger, acquisition, or sale of assets, with appropriate confidentiality protections</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4 text-[15px] text-[#707070] leading-[1.65]">
