        ...
        <div className="space-y-10" style={BODY}>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-[15px] text-[#707070] leading-[1.65]">
              <li><strong className="text-[#1d1d1f] font-medium">Setup Fee:</strong> The setup fee is a one-time, non-refundable payment that covers onboarding, configuration, scripting, and testing. Payment of the setup fee initiates the onboarding process.</li>
              <li><strong className="text-[#1d1d1f] font-medium">Monthly Subscription:</strong> Monthly fees are billed in advance on a recurring basis. Your subscription begins on your go-live date.</li>
              <li><strong className="text-[#1d1d1f] font-medium">Founding Client Pricing:</strong> Clients who join during the Founding Client period (first 20 paying customers) will have their monthly subscription rate locked at $199/month for as long as their subscription remains continuously active and in good standing. Founding rates apply only to the original subscription tier and do not transfer to upgraded service tiers.</li>
              <li><strong className="text-[#1d1d1f] font-medium">Price Changes:</strong> We reserve the right to change subscription pricing with 30 days&apos; written notice to non-founding clients.</li>
            </ul>
          </section>
